...
public class XugglerRtmpReferenceImpl {
    ...
    private static String url = "rtmp://127.0.0.1/screen/";
    private static String fileName = "D:/video/Neft.avi";
    ...
    public static void main(String[] args) {
        ...
        containerFormat_live.setOutputFormat("avi", url + fileName, null);
